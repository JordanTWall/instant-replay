...
const AwayTD2: React.FC<AwayTD2Props> = ({ backgroundColor, textColor, playerImg }) => (
  <svg width="156.0" height="273.0" viewBox="0 0 104 182" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g transform="scale(-1, 1) translate(-104, 0)">
      ...
      <g>
        ...
        <image href={playerImg} x="34" y="-10" width="80" height="80" clipPath="circle(30)" />
      </g>
    </g>
  </svg>
);

export default AwayTD2;
