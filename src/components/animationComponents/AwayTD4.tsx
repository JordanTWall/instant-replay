...
const AwayTD4: React.FC<AwayTD4Props> = ({ backgroundColor, textColor, playerImg }) => (
  <svg width="123.0" height="300.0" viewBox="0 0 82 200" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g transform="scale(-1, 1) translate(-82, 0)">
      ...
      <g>
        ...
        <image href={playerImg} x="10" y="-10" width="80" height="80" clipPath="circle(30)" />
      </g>
    </g>
  </svg>
);

export default AwayTD4;
