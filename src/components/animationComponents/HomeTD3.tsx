...
const HomeTD3: React.FC<HomeTD3Props> = ({ backgroundColor, textColor, playerImg }) => (
  <svg width="114.0" height="286.5" viewBox="0 0 76 191" fill="none" xmlns="http://www.w3.org/2000/svg" transform="translate(35, 0)">
