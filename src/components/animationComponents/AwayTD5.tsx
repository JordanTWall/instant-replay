...
const AwayTD5: React.FC<AwayTD5Props> = ({ backgroundColor, textColor, playerImg }) => (
  <svg width="172.5" height="280.5" viewBox="0 0 115 187" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g transform="scale(-1, 1) translate(-115, 0)">
      ...
      <g>
        ...
        <image href={playerImg} x="40" y="-10" width="80" height="80" clipPath="circle(30)" />
      </g>
    </g>
  </svg>
);

export default AwayTD5;
